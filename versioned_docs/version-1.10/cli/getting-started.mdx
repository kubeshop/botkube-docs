...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.10.0/botkube-darwin-arm64
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.10.0/botkube-darwin-amd64
chmod +x botkube && mv botkube /usr/local/bin/botkube
```
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.10.0/botkube-linux-amd64
chmod +x botkube && mv botkube /usr/local/bin/botkube
```
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.10.0/botkube-windows-amd64.exe
```
...
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.10.0/botkube-${OS}-${ARCH}${SUFFIX}
```
