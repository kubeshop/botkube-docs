---
id: cloud-slack
title: Botkube Cloud App for Slack
sidebar_position: 1
---
...
Upon extending an invitation to Botkube for a private channel, a prompt will appear, guiding you through the process of creating a public alias. This step ensures smooth communication and integration.
