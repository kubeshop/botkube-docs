...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.1.1/botkube-darwin-arm64
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.1.1/botkube-darwin-amd64
chmod +x botkube && mv botkube /usr/local/bin/botkube
```
