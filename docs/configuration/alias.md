...
Aliases work for all commands, including executor plugins and Botkube built-in ones. To learn more how to configure Executors, see the [Executor](./executor/index.md) section.
