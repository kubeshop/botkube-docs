...
import archivedVersionsMap from "@site/chatPlatform_versions-archived.json";
import { useGitHubReleases } from "../hooks/github-releases";
import { getPathForVersion } from "./fuse-cli-versions";

const docsPluginId = "chatPlatform"; // Default docs plugin instance
