...
The previous Microsoft Teams app has been deprecated. If you need to use the legacy Microsoft Teams app, see the [Botkube 1.5 Documentation](/1.5/installation/teams/). It is recommended to migrate to the new Microsoft Teams app per the below instructions.
