...
2. Deploy Botkube into your environment.
...
8. Include optional `default aliases` and `default actions` and click `Apply Changes` button to update Botkube Cloud instance.
