      ...
      <main className="container">
        <section className={styles.mainSlogan}>
          ...
          <p className={styles.mainSloganDesc}>
            BotKube can be integrated with multiple messaging platforms like Slack, Microsoft Teams, Discord, or Mattermost to
            help you monitor your Kubernetes cluster(s), debug critical deployments, and get recommendations for
            standard practices by running checks on Kubernetes resources.
          </p>
        </section>
        <section className={styles.whatCanDo}>
          ...
          <div className={clsx("row", styles.whatCanDoFeature)}>
            <div className="col col-6">
              ...
              <ul>
                <li>
                  BotKube watches Kubernetes resources and sends a notification to the configured channel if any event occurs, for
                  example, an ImagePullBackOff error.
                </li>
