...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.2.0/botkube-darwin-arm64
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.2.0/botkube-darwin-amd64
chmod +x botkube && mv botkube /usr/local/bin/botkube
```
...
You might need to use "sudo" to run the cmd mv as it is moving the binary file under the directory /usr/local/bin/ 

```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.2.0/botkube-linux-amd64
chmod +x botkube && mv botkube /usr/local/bin/botkube
```
...
```shell
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.2.0/botkube-windows-amd64.exe
```
...
curl -Lo botkube https://github.com/kubeshop/botkube/releases/download/v1.2.0/botkube-${OS}-${ARCH}${SUFFIX}
```
