---
id: self-hosted-ms-teams
title: "Microsoft Teams for self-hosted Botkube"
sidebar_position: 2
---

The self-hosted Microsoft Teams integration works with the open-source Botkube Agent and does not require an account or subscription.
