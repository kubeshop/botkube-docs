...
| ---------------------------------------------------------------- | ------------------ | ------------------ | ------------------ | ------------------ | ------------------ |
| Source plugins support (e.g. `kubernetes`, `prometheus`, etc.)   | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| Executor plugins support (e.g. `kubectl`, `helm`, etc.)          | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
...
_see the [configuration](../configuration/index.mdx) section for more information_
:::
