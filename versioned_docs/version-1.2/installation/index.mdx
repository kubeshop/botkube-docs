...
| Feature                                                | Cloud Slack        | Slack              | Mattermost         | MS Teams           | Discord            | Elasticsearch      | Webhook            |
| ------------------------------------------------------ | ------------------ | ------------------ | ------------------ | ------------------ | ------------------ | ------------------ | ------------------ |
...
| Executor plugins (e.g. `kubectl`, `helm`, etc.)        | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | NA                 | NA                 |
| Source plugins (e.g. `kubernetes`, `prometheus`, etc.) | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| Multi cluster support                                  | :heavy_check_mark: | :x:                | :heavy_check_mark: | :x:                | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
| Per-channel command execution configuration            | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :x:                | :heavy_check_mark: | NA                 | NA                 |
| Interactive messages                                   | :heavy_check_mark: | :heavy_check_mark: | :x:                | :x:                | :x:                | NA                 | NA                 |
| Actionable notifications                               | :heavy_check_mark: | :heavy_check_mark: | :x:                | :x:                | :x:                | NA                 | NA                 |
